...
Class YobitClient
{
	protected $tradingUrl = 'https://yobit.net/tapi/';
	protected $publicUrlV2 = 'https://yobit.net/api/2/';
	protected $publicUrlV3 = 'https://yobit.net/api/3/';
	private $key;
	private $secret;
	...
	private function tradeRequest($method, array $parameters = [], $isRetry = false) {
		...
		if (is_null($ch)) {
			...
			curl_setopt($ch, CURLOPT_USERAGENT, 'Mozilla/4.0 (compatible; Yobit PHP-Laravel Client; '.php_uname('a')
				.'; PHP/'.phpversion().')');
		}
